...
def train_and_evaluate(model, train_dataloader, val_dataloader, optimizer, loss_fn, metrics, params, model_dir,
    ...
    if restore_file is not None:
        ...
        start_epoch = utils.load_checkpoint(restore_path, model, optimizer)
    ...
    for epoch in range(start_epoch, params.num_epochs):
        ...
        if is_best:
            logging.info("- Found lower validation loss")
...
if __name__ == '__main__':
    ...
    dataloaders = data_loader.fetch_dataloader(['train', 'valid'], data_dir, params)
    ...
    model = net.Net(input_channels, output_channels).cuda() if params.cuda else net.Net(input_channels, output_channels)
